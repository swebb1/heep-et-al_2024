...
## Read profiles over SPIN1 peaks
...
rs@rowRanges$Group <- ifelse(rs@rowRanges$V4 %in% line_co$V4,"LINE_Element",
             ifelse(rs@rowRanges$V4 %in% rep_genic_noline_co$V4,"Other_Repeat_Genic",
             ifelse(rs@rowRanges$V4 %in% rep_inter_noline_co$V4,"Other_Repeat_Intergenic",
             ifelse(rs@rowRanges$V4 %in% gene_noline_co$V4,"Gene",
             ifelse(rs@rowRanges$V4 %in% inter_noline_co$V4,"Intergenic","")
             )))) 
...
rsl2@rowRanges$Group <- ifelse(rsl2@rowRanges$V4 %in% line_co$V4,"LINE_Element",
             ifelse(rsl2@rowRanges$V4 %in% rep_genic_noline_co$V4,"Other_Repeat_Genic",
             ifelse(rsl2@rowRanges$V4 %in% rep_inter_noline_co$V4,"Other_Repeat_Intergenic",
             ifelse(rsl2@rowRanges$V4 %in% gene_noline_co$V4,"Gene",
             ifelse(rsl2@rowRanges$V4 %in% inter_noline_co$V4,"Intergenic","")
             ))))
